...
import { PersonalFinanceFoundationsSeeder } from './personal-finance-foundations.seeder.js';
import { buildPersonalFinanceFoundationsSeedData } from './personal-finance-foundations.seed-data.js';

const DOMAIN_ID = 'e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a55';
const PATH_ID = 'f0eebc99-9c0b-4ef8-bb6d-6bb9bd380a66';

describe('PersonalFinanceFoundationsSeeder', () => {
  ...
  it('creates the domain, path and every competency on a first run', async () => {
    ...
    const seeder = new PersonalFinanceFoundationsSeeder(definitionsService);
