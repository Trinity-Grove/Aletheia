...
import { HomeSufficiencyFoundationsSeeder } from './home-sufficiency-foundations.seeder.js';
import { buildHomeSufficiencyFoundationsSeedData } from './home-sufficiency-foundations.seed-data.js';

const DOMAIN_ID = 'c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a33';
const PATH_ID = 'd0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44';

describe('HomeSufficiencyFoundationsSeeder', () => {
  ...
  it('creates the domain, path and every competency on a first run', async () => {
    ...
    const seeder = new HomeSufficiencyFoundationsSeeder(definitionsService);
