...
import { TradesMechanicalElectricalHomeSeeder } from './trades-mechanical-electrical-home.seeder.js';
import { buildTradesMechanicalElectricalHomeSeedData } from './trades-mechanical-electrical-home.seed-data.js';

const DOMAIN_ID = 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14';

const seedDataForPathIds = buildTradesMechanicalElectricalHomeSeedData();
...
describe('TradesMechanicalElectricalHomeSeeder', () => {
  ...
  it('creates every trade path and its competencies when the TRADES domain already exists (the normal case)', async () => {
    ...
    const seeder = new TradesMechanicalElectricalHomeSeeder(definitionsService);
