...
import { BiblicalFormationOriginalLanguagesLiteracySeeder } from './biblical-formation-original-languages-literacy.seeder.js';
import { buildOriginalLanguagesLiteracySeedData } from './biblical-formation-original-languages-literacy.seed-data.js';

const DOMAIN_ID = 'e0eebc99-9c0b-4ef8-bb6d-6bb9bd380b55';
const PATH_ID = 'f0eebc99-9c0b-4ef8-bb6d-6bb9bd380b66';

describe('BiblicalFormationOriginalLanguagesLiteracySeeder', () => {
  ...
  it('creates the path and every competency when the FAITH.BIBLICAL_FORMATION domain already exists (the normal case)', async () => {
    ...
    const seeder = new BiblicalFormationOriginalLanguagesLiteracySeeder(definitionsService);
