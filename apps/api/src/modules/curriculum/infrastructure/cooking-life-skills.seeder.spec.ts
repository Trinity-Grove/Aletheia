...
import { CookingLifeSkillsSeeder } from './cooking-life-skills.seeder.js';
import { buildCookingLifeSkillsSeedData } from './cooking-life-skills.seed-data.js';

const DOMAIN_ID = 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380c11';
const PATH_ID = 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380c22';

describe('CookingLifeSkillsSeeder', () => {
  ...
  it('creates the path and every competency when the COOKING domain already exists (the normal case)', async () => {
    ...
    const seeder = new CookingLifeSkillsSeeder(definitionsService);
