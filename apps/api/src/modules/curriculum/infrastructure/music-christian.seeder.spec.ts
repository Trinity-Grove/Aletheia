...
import { MusicChristianSeeder } from './music-christian.seeder.js';
import { buildMusicChristianSeedData } from './music-christian.seed-data.js';

const DOMAIN_ID = 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a16';
const PATH_ID = 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a26';

describe('MusicChristianSeeder', () => {
  const seedData = buildMusicChristianSeedData();

  it('creates the path and every competency when the MUSIC domain already exists (the normal case)', async () => {
    ...
    const seeder = new MusicChristianSeeder(definitionsService);
