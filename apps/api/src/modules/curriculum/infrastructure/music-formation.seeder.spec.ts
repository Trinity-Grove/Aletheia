...
describe('MusicFormationSeeder', () => {
  ...
  it('creates the domain, path and every competency on a first run', async () => {
    ...
    const seeder = new MusicFormationSeeder(definitionsService);
