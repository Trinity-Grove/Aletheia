...
import { BiblicalFormationTextTransmissionSeeder } from './biblical-formation-text-transmission.seeder.js';
import { buildTextTransmissionSeedData } from './biblical-formation-text-transmission.seed-data.js';

const DOMAIN_ID = 'e0eebc99-9c0b-4ef8-bb6d-6bb9bd380c55';
const PATH_ID = 'f0eebc99-9c0b-4ef8-bb6d-6bb9bd380c66';

describe('BiblicalFormationTextTransmissionSeeder', () => {
  const seedData = buildTextTransmissionSeedData();
  ...
  it('creates the path and every competency when the FAITH.BIBLICAL_FORMATION domain already exists (the normal case)', async () => {
    ...
    const seeder = new BiblicalFormationTextTransmissionSeeder(definitionsService);
